...
{
    /// <inheritdoc />
    public partial class AddInitialCinemaSystemToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_MovieId_ApplicationUserId",
                table: "Reviews",
                columns: new[] { "MovieId", "ApplicationUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Seats_CinemaHallId_Row_Column",
                table: "Seats",
                columns: new[] { "CinemaHallId", "Row", "Column" },
                unique: true);
