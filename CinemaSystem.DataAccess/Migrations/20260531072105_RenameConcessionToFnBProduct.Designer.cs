...
namespace CinemaSystem.DataAccess.Migrations
{
    ...
    [Migration("20260531072105_RenameConcessionToFnBProduct")]
    partial class RenameConcessionToFnBProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaSystem.Models.Entities.BookingFnB", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaSystem.Models.Entities.Equipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaSystem.Models.Entities.FnBProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaSystem.Models.Entities.Movie", b =>
                {
                    ...
                    b.Property<string>("RottenTomatoesScore")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CinemaSystem.Models.Entities.ApplicationUser", b =>
                {
                    b.HasOne("CinemaSystem.Models.Entities.Cinema", "PreferredCinema")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaSystem.Models.Entities.BookingFnB", b =>
                {
                    ...
                    b.HasOne("CinemaSystem.Models.Entities.FnBProduct", "FnBProduct")
                        .WithMany()
                        .HasForeignKey("FnBProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Booking");

                    b.Navigation("FnBProduct");
                });
            ...
            modelBuilder.Entity("CinemaSystem.Models.Entities.Review", b =>
                {
                    b.HasOne("CinemaSystem.Models.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany("Reviews")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
